  ...
  return (
    <main className={style.container}>
      ...
      <section className={style.contentHistory}>
        ...
        <button onClick={handleScrollToTop} className={style.button}><GiSpiralArrow className={style.arrow1}/> Voltar ao inicio <GiSpiralArrow className={style.arrow1}/></button>
      </section>
    </main>
  );
};